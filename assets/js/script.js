...
async function getAboutGitHub() {
	try {
		...
		const resposta = await fetch(
			'https://api.github.com/users/daniellacamilo',
		)
      ...
      <article class="about-content">
        ...
        <p>
		Atualmente, estou em busca de oportunidades para aplicar minhas habilidades e contribuir para projetos desafiadores.
		</p>

        <div class="about-buttons-data">
          <div class="buttons-container">
            <a href="${perfil.html_url}" target="_blank" class="botao">GitHub</a>
            <a href="https://drive.google.com/file/d/1SnGgec7_TyOkJpioboB7-0CZ0HhujyjL/view" target="_blank" class="botao-outline">Currículo</a>
          </div>
...
async function getProjectsGitHub() {
	try {
		// Requisição do tipo GET para a API do GitHub
		const resposta = await fetch('https://api.github.com/users/daniellacamilo/repos?sort=updated&per_page=6');
 ...
 // Função de inicialização do Swiper (Carrossel)
